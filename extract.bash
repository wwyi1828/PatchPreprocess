...
# CUDA_VISIBLE_DEVICES=1 python 1_extract_pretrain_feats.py --config='configs/trastuzumab.yaml' --batch_size 16 --model_type Virchow2
# CUDA_VISIBLE_DEVICES=1 python 1_extract_pretrain_feats.py --config='configs/Yale_HER2.yaml' --batch_size 16 --model_type Virchow2
# CUDA_VISIBLE_DEVICES=1 python 1_extract_pretrain_feats.py --config='configs/TCGA_BRAC.yaml' --batch_size 16 --model_type Virchow2

CUDA_VISIBLE_DEVICES=0 python 1_extract_pretrain_feats.py --config='configs/TCGA_Lung.yaml' --batch_size 32 --model_type UNI & 
CUDA_VISIBLE_DEVICES=1 python 1_extract_pretrain_feats.py --config='configs/TCGA_Lung_20x.yaml' --batch_size 32 --model_type UNI &
CUDA_VISIBLE_DEVICES=2 python 1_extract_pretrain_feats.py --config='configs/TCGA_LGG.yaml' --batch_size 32 --model_type UNI & 
wait


# {
#    CUDA_VISIBLE_DEVICES=0 python 1_extract_pretrain_feats.py --config='configs/BRACS_train.yaml' --batch_size 16 --model_type Virchow2
#    CUDA_VISIBLE_DEVICES=0 python 1_extract_pretrain_feats.py --config='configs/C16_test.yaml' --batch_size 16 --model_type Virchow2
# } & 
# {
#     CUDA_VISIBLE_DEVICES=2 python 1_extract_pretrain_feats.py --config='configs/BRACS_val.yaml' --batch_size 16 --model_type Virchow2
#     CUDA_VISIBLE_DEVICES=2 python 1_extract_pretrain_feats.py --config='configs/BRACS_test.yaml' --batch_size 16 --model_type Virchow2
#     CUDA_VISIBLE_DEVICES=2 python 1_extract_pretrain_feats.py --config='configs/C16.yaml' --batch_size 16 --model_type Virchow2
# } &
# wait

# CUDA_VISIBLE_DEVICES=0 python 1_extract_pretrain_feats.py --config='configs/BRACS_train.yaml' --batch_size 1024 --model_type Virchow2
# CUDA_VISIBLE_DEVICES=2 python 1_extract_pretrain_feats.py --config='configs/BRACS_val.yaml' --batch_size 1024 --model_type Virchow2
# CUDA_VISIBLE_DEVICES=2 python 1_extract_pretrain_feats.py --config='configs/BRACS_test.yaml' --batch_size 1024 --model_type Virchow2
