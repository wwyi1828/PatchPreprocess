...
parser.add_argument('--mapping_file', default=None,
                    help="Optional Ensembl-to-symbol pickle cache. Defaults to <data_root>/ensembl_to_symbol_mapping.pkl.")
...
mapping_file = Path(args.mapping_file) if args.mapping_file else datastem / "ensembl_to_symbol_mapping.pkl"
